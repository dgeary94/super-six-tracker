(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))h(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const m of o.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&h(m)}).observe(document,{childList:!0,subtree:!0});function c(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerpolicy&&(o.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?o.credentials="include":e.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function h(e){if(e.ep)return;e.ep=!0;const o=c(e);fetch(e.href,o)}})();const O="/super-six-tracker/assets/super-six-scores.dca1fac3.csv",T="/super-six-tracker/assets/football.b99eb6b5.svg";document.querySelector("#app").innerHTML=`
  <div id="title">
  ...
  <div id="graph"><div>`;document.getElementById("football").src=T;const l={top:40,right:80,bottom:40,left:80},g=800-l.left-l.right,R=500-l.top-l.bottom,S=g/R;let i=null,u=null;function $(r,a){const c=window.innerWidth,h=window.innerHeight;return c/h>S?(a=R,r=g):(r=c+l.left,a=r/S),[r,a]}[i,u]=$();document.querySelector("#app").innerHTML+=`<table width=${i}>
 <thead>
     <tr>
       <th></th>
       <th>Andy</th>
